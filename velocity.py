...
class Velocity:
	def __init__(self, model_velocity = 1, low_velocity = 1, high_velocity = 1, yesterdays_velocity = 1):
		self.model = model_velocity
		self.low = low_velocity
		self.high = high_velocity
		self.yesterday = yesterdays_velocity
